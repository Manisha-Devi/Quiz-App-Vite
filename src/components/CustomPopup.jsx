...
const CustomPopup = ({ message, type, onClose, isVisible, showConfirm, onConfirm, onCancel, contained = false }) => {
  ...
  return (
    <div className={`popup-backdrop ${contained ? 'contained' : ''}`} onClick={onClose}>
      <div className={`popup-container popup-${type} ${contained ? 'contained' : ''}`} onClick={(e) => e.stopPropagation()}>
